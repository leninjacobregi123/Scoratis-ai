 ...
 *                      two universal kinds).
 */
export interface Scene<TAction = never, TContent extends {
    type: SceneType;
 ...
 */
export declare function isSlideContent<T extends {
    type: SceneType;
}>(content: T): content is T & SlideContent;
/**
 ...
 * Pure, no runtime deps.
 */
export declare function isQuizContent<T extends {
    type: SceneType;
}>(content: T): content is T & QuizContent;
