...
var BaseCodeElement = require('./BaseCodeElement-C4RFPT0H.cjs');
...
function SlideElement({ elementInfo, elementIndex, theme, animate, renderImage, renderVideo, onElementClick, idPrefix = 'slide-element-', }) {
    const Component = react.useMemo(() => {
        switch (elementInfo.type) {
            case dsl.ElementTypes.IMAGE:
                return 'image';
            case dsl.ElementTypes.TEXT:
                return 'text';
            case dsl.ElementTypes.SHAPE:
                return 'shape';
            case dsl.ElementTypes.LINE:
                return 'line';
            case dsl.ElementTypes.CHART:
                return 'chart';
            case dsl.ElementTypes.LATEX:
                return 'latex';
            case dsl.ElementTypes.TABLE:
                return 'table';
            case dsl.ElementTypes.VIDEO:
                return 'video';
            case dsl.ElementTypes.CODE:
                return 'code';
            default:
                return null;
        }
    ...
    return (jsxRuntime.jsxs("div", { className: "slide-element", id: `${idPrefix}${elementInfo.id}`, style: { zIndex: elementIndex, color: fontColor, fontFamily: fontName }, onClick: onElementClick ? (e) => onElementClick(elementInfo, e) : undefined, children: [Component === 'text' && elementInfo.type === 'text' && (jsxRuntime.jsx(BaseCodeElement.BaseTextElement, { elementInfo: elementInfo })), Component === 'shape' && elementInfo.type === 'shape' && (jsxRuntime.jsx(BaseCodeElement.BaseShapeElement, { elementInfo: elementInfo })), Component === 'image' && elementInfo.type === 'image' && (jsxRuntime.jsx(BaseCodeElement.BaseImageElement, { elementInfo: elementInfo, renderImage: renderImage })), Component === 'line' && elementInfo.type === 'line' && (jsxRuntime.jsx(BaseCodeElement.BaseLineElement, { elementInfo: elementInfo, animate: animate })), Component === 'chart' && elementInfo.type === 'chart' && (jsxRuntime.jsx(BaseCodeElement.BaseChartElement, { elementInfo: elementInfo })), Component === 'latex' && elementInfo.type === 'latex' && (jsxRuntime.jsx(BaseCodeElement.BaseLatexElement, { elementInfo: elementInfo })), Component === 'table' && elementInfo.type === 'table' && (jsxRuntime.jsx(BaseCodeElement.BaseTableElement, { elementInfo: elementInfo })), Component === 'video' && elementInfo.type === 'video' && (jsxRuntime.jsx(BaseCodeElement.BaseVideoElement, { elementInfo: elementInfo, renderVideo: renderVideo })), Component === 'code' && elementInfo.type === 'code' && (jsxRuntime.jsx(BaseCodeElement.BaseCodeElement, { elementInfo: elementInfo, animate: animate }))] }));
}
...
function HighlightOverlay({ element, options }) {
    ...
    return (jsxRuntime.jsxs("div", { className: "highlight-overlay", style: {
            position: 'absolute',
            pointerEvents: 'none',
            ...
            transition: 'all 0.3s ease-in-out',
        }, children: [jsxRuntime.jsx("div", { className: animated ? 'slide-renderer-pulse' : undefined, style: {
                    position: 'absolute',
                    inset: 0,
                    borderRadius: '4px',
                    ...
                    backgroundColor: `${color}${Math.round(opacity * 255)
                        .toString(16)
                        .padStart(2, '0')}`,
                } }), animated && (jsxRuntime.jsx("div", { className: "slide-renderer-ping", style: {
                    position: 'absolute',
                    inset: 0,
                    borderRadius: '4px',
                    border: `${borderWidth}px solid ${color}`,
...
function SpotlightOverlay({ options, elementIdPrefix = 'slide-element-', }) {
    ...
    return (jsxRuntime.jsx("div", { ref: containerRef, style: {
            ...
            pointerEvents: 'none',
            overflow: 'hidden',
        }, children: jsxRuntime.jsx(react$1.AnimatePresence, { mode: "wait", children: active && rect && (jsxRuntime.jsx(react$1.motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, style: { position: 'absolute', inset: 0 }, children: jsxRuntime.jsxs("svg", { width: "100%", height: "100%", viewBox: "0 0 100 100", preserveAspectRatio: "none", style: { position: 'absolute', inset: 0 }, children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("mask", { id: `mask-${spotlightElementId}`, children: [jsxRuntime.jsx("rect", { x: "0", y: "0", width: "100", height: "100", fill: "white" }), jsxRuntime.jsx(react$1.motion.rect, { fill: "black", initial: {
                                            x: rect.x - 8,
                                            y: rect.y - 8,
                                            width: rect.w + 16,
                                            height: rect.h + 16,
                                            ...
                                            height: rect.h + 1.2,
                                            rx: 1,
                                        }, transition: { duration: 0.6, ease: [0.16, 1, 0.3, 1] } })] }) }), jsxRuntime.jsx("rect", { width: "100", height: "100", fill: "rgba(0,0,0,0.7)", mask: `url(#mask-${spotlightElementId})` }), jsxRuntime.jsx(react$1.motion.rect, { initial: {
                                x: rect.x - 4,
                                y: rect.y - 4,
                                width: rect.w + 8,
                                height: rect.h + 8,
...
function LaserOverlay({ geometry, color = '#ff3b30', duration: _duration = 3000, }) {
    ...
    return (jsxRuntime.jsx(react$1.motion.div, { initial: { opacity: 0, left: `${startPos.x}%`, top: `${startPos.y}%` }, animate: { opacity: 1, left: `${centerX}%`, top: `${centerY}%` }, exit: {
            opacity: 0,
            left: `${startPos.x}%`,
            top: `${startPos.y}%`,
        ...
        }, style: { position: 'absolute', zIndex: 101, pointerEvents: 'none' }, children: jsxRuntime.jsxs("div", { style: { position: 'relative', transform: 'translate(-50%, -50%)' }, children: [jsxRuntime.jsx(react$1.motion.div, { animate: { scale: [1, 2.8], opacity: [0.6, 0] }, transition: {
                        repeat: Infinity,
                        duration: 1.5,
                        ease: 'easeOut',
                        repeatDelay: 0.3,
...
function SlideRendererProvider({ children, className, style, ...value }) {
    return (jsxRuntime.jsx(SlideContext.Provider, { value: value, children: className || style ? (jsxRuntime.jsx("div", { className: className, style: style, children: children })) : (children) }));
}
/**
...
function useSlideContext() {
    const value = react.useContext(SlideContext);
    if (!value) {
...
function SlideCanvas(props) {
    ...
    const highlightElement = effects?.highlight
        ...
        : null;
    return (jsxRuntime.jsxs("div", { ref: canvasRef, className: className, style: {
            position: 'relative',
            width: '100%',
            height: '100%',
            overflow: 'hidden',
            userSelect: 'none',
            ...style,
        }, children: [jsxRuntime.jsx("style", { dangerouslySetInnerHTML: { __html: SLIDE_RENDERER_STYLES } }), jsxRuntime.jsxs("div", { style: {
                    position: 'absolute',
                    ...(chrome
                        ? {
                    ...
                    ...(effects?.zoom && zoomGeometry
                        ...
                        }, children: [elements.map((element, index) => (jsxRuntime.jsx(SlideElement, { elementInfo: element, elementIndex: index + 1, theme: slide.theme, renderImage: renderImage, renderVideo: renderVideo, onElementClick: onElementClick }, element.id))), highlightElement && (jsxRuntime.jsx(HighlightOverlay, { element: highlightElement, options: effects?.highlight }))] }), jsxRuntime.jsx(SpotlightOverlay, { options: effects?.spotlight }), jsxRuntime.jsx("div", { style: {
                            position: 'absolute',
                            inset: 0,
                            pointerEvents: 'none',
                            padding: '5%',
                        }, children: jsxRuntime.jsx("div", { style: { position: 'relative', width: '100%', height: '100%' }, children: jsxRuntime.jsx(react$1.AnimatePresence, { children: effects?.laser && laserGeometry && (jsxRuntime.jsx(LaserOverlay, { geometry: laserGeometry, color: effects.laser.color, duration: effects.laser.duration }, `laser-${effects.laser.elementId}`)) }) }) })] })] }));
}

exports.HighlightOverlay = HighlightOverlay;
exports.LaserOverlay = LaserOverlay;
exports.SlideCanvas = SlideCanvas;
exports.SlideElement = SlideElement;
exports.SlideRendererProvider = SlideRendererProvider;
exports.SpotlightOverlay = SpotlightOverlay;
exports.findElementGeometry = findElementGeometry;
exports.findNearestCorner = findNearestCorner;
exports.getElementPercentageGeometry = getElementPercentageGeometry;
exports.useOptionalSlideContext = useOptionalSlideContext;
exports.useSlideBackgroundStyle = useSlideBackgroundStyle;
exports.useSlideContext = useSlideContext;
exports.useViewportSize = useViewportSize;
//# sourceMappingURL=SlideCanvas-BjVHdBXf.cjs.map
