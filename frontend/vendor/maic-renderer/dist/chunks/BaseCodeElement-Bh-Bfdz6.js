...
function ImageRectOutline({ width, height, outline, radius = '0' }) {
    ...
    if (!outline)
        return null;
    return (jsx("svg", { style: { position: 'absolute', top: 0, left: 0, zIndex: 2, overflow: 'visible' }, width: width, height: height, children: jsx("rect", { vectorEffect: "non-scaling-stroke", strokeLinecap: "butt", strokeMiterlimit: "8", fill: "transparent", rx: radius, ry: radius, width: width, height: height, stroke: outlineColor, strokeWidth: outlineWidth, strokeDasharray: strokeDashArray }) }));
}
function ImageEllipseOutline({ width, height, outline }) {
    const { outlineWidth, outlineColor, strokeDashArray } = useElementOutline(outline);
    if (!outline)
        return null;
    return (jsx("svg", { style: { position: 'absolute', top: 0, left: 0, zIndex: 2, overflow: 'visible' }, width: width, height: height, children: jsx("ellipse", { vectorEffect: "non-scaling-stroke", strokeLinecap: "butt", strokeMiterlimit: "8", fill: "transparent", cx: width / 2, cy: height / 2, rx: width / 2, ry: height / 2, stroke: outlineColor, strokeWidth: outlineWidth, strokeDasharray: strokeDashArray }) }));
}
function ImagePolygonOutline({ width, height, createPath, outline }) {
    const { outlineWidth, outlineColor, strokeDashArray } = useElementOutline(outline);
    if (!outline)
        return null;
    return (jsx("svg", { style: { position: 'absolute', top: 0, left: 0, zIndex: 2, overflow: 'visible' }, width: width, height: height, children: jsx("path", { vectorEffect: "non-scaling-stroke", strokeLinecap: "butt", strokeMiterlimit: "8", fill: "transparent", d: createPath(width, height), stroke: outlineColor, strokeWidth: outlineWidth, strokeDasharray: strokeDashArray }) }));
}
function ImageOutline({ elementInfo }) {
    const { clipShape } = useClipImage(elementInfo);
    return (jsxs("div", { className: "image-outline", children: [clipShape.type === 'rect' && (jsx(ImageRectOutline, { width: elementInfo.width, height: elementInfo.height, radius: clipShape.radius, outline: elementInfo.outline })), clipShape.type === 'ellipse' && (jsx(ImageEllipseOutline, { width: elementInfo.width, height: elementInfo.height, outline: elementInfo.outline })), clipShape.type === 'polygon' && clipShape.createPath && (jsx(ImagePolygonOutline, { width: elementInfo.width, height: elementInfo.height, outline: elementInfo.outline, createPath: clipShape.createPath }))] }));
}
...
function BaseImageElement({ elementInfo, renderImage }) {
    ...
    const softEdgeMaskStyle = softEdge
        ...
        : {};
    return (jsx("div", { className: "element-content", style: {
            position: 'absolute',
            ...
            height: `${elementInfo.height}px`,
                ...
                transform: `rotate(${elementInfo.rotate}deg)`,
                    ...
                    transform: flipStyle,
                }, children: [jsx(ImageOutline, { elementInfo: elementInfo }), jsx("div", { style: {
                            position: 'relative',
                            width: '100%',
                            height: '100%',
                            overflow: 'hidden',
                            clipPath: clipShape.style,
                        }, children: renderImage ? (renderImage(elementInfo, src)) : src ? (jsxs(Fragment, { children: [jsx("img", { src: src, draggable: false, "data-soft-edge": softEdge || undefined, style: {
                                        position: 'absolute',
                                        top: imgPosition.top,
                                        ...
                                        filter,
                                        ...softEdgeMaskStyle,
                                    }, alt: "", onDragStart: (e) => e.preventDefault() }), elementInfo.colorMask && (jsx("div", { style: {
                                        position: 'absolute',
                                        inset: 0,
...
function ElementOutline({ width, height, outline }) {
    ...
    if (!outline)
        return null;
    return (jsx("svg", { className: "element-outline", style: { position: 'absolute', top: 0, left: 0, overflow: 'visible' }, width: width, height: height, children: jsx("path", { vectorEffect: "non-scaling-stroke", strokeLinecap: "butt", strokeMiterlimit: "8", fill: "transparent", d: `M0,0 L${width},0 L${width},${height} L0,${height} Z`, stroke: outlineColor, strokeWidth: outlineWidth, strokeDasharray: strokeDashArray }) }));
}
...
function BaseTextElement({ elementInfo, target }) {
    ...
    return (jsx("div", { className: "base-element-text", style: {
            position: 'absolute',
            top: `${elementInfo.top}px`,
            left: `${elementInfo.left}px`,
            width: `${elementInfo.width}px`,
            ...
            opacity: elementInfo.opacity,
        }, children: jsx("div", { className: "rotate-wrapper", style: {
                width: '100%',
                height: '100%',
                transform: `rotate(${elementInfo.rotate}deg)`,
                display: 'flex',
                ...
                justifyContent,
            }, children: jsxs("div", { className: "element-content slide-renderer-prose", style: {
                    position: 'relative',
                    ...
                    ...(elementInfo.paragraphSpace !== undefined
                        ...
                        : null),
                }, children: [jsx(ElementOutline, { width: elementInfo.width, height: elementInfo.height, outline: elementInfo.outline }), jsx("div", { className: "text ProseMirror-static", style: {
                            position: 'relative',
...
function GradientDefs({ id, type, colors, rotate = 0 }) {
    if (type === 'linear') {
        return (jsx("linearGradient", { id: id, x1: "0%", y1: "0%", x2: "100%", y2: "0%", gradientTransform: `rotate(${rotate},0.5,0.5)`, children: colors.map((item, index) => (jsx("stop", { offset: `${item.pos}%`, stopColor: item.color }, index))) }));
    }
    return (jsx("radialGradient", { id: id, children: colors.map((item, index) => (jsx("stop", { offset: `${item.pos}%`, stopColor: item.color }, index))) }));
}

function PatternDefs({ id, src }) {
    return (jsx("pattern", { id: id, patternContentUnits: "objectBoundingBox", patternUnits: "objectBoundingBox", width: "1", height: "1", children: jsx("image", { href: src, width: "1", height: "1", preserveAspectRatio: "xMidYMid slice" }) }));
}
...
function BaseShapeElement({ elementInfo }) {
    ...
    return (jsx("div", { className: "base-element-shape", style: {
            position: 'absolute',
            top: `${elementInfo.top}px`,
            left: `${elementInfo.left}px`,
            width: `${elementInfo.width}px`,
            height: `${elementInfo.height}px`,
                ...
                height: '100%',
                transform: `rotate(${elementInfo.rotate}deg)`,
            }, children: jsxs("div", { className: "element-content", style: {
                    position: 'relative',
                    width: '100%',
                    height: '100%',
                    opacity: elementInfo.opacity,
                    ...
                    fontFamily: text.defaultFontName,
                        ...
                        return (jsxs("svg", { overflow: "visible", width: elementInfo.width + padL + padR, height: elementInfo.height + padT + padB, style: {
                                position: 'absolute',
                                left: -padL,
                                top: -padT,
                                transformOrigin: '0 0',
                                overflow: 'visible',
                                display: 'block',
                            }, children: [jsxs("defs", { children: [elementInfo.pattern && (jsx(PatternDefs, { id: `base-pattern-${elementInfo.id}`, src: elementInfo.pattern })), elementInfo.gradient && (jsx(GradientDefs, { id: `base-gradient-${elementInfo.id}`, type: elementInfo.gradient.type, colors: elementInfo.gradient.colors, rotate: elementInfo.gradient.rotate }))] }), jsx("g", { transform: `translate(${padL},${padT}) scale(${sx}, ${sy})`, children: jsx("path", { vectorEffect: "non-scaling-stroke", strokeLinecap: "butt", strokeMiterlimit: "8", d: elementInfo.path, fill: fill, stroke: outlineColor, strokeWidth: outlineWidth, strokeDasharray: strokeDashArray }) })] }));
                    })(), jsx("div", { className: "shape-text", style: {
                            position: 'absolute',
                            inset: 0,
                            display: 'flex',
                            flexDirection: 'column',
                            ...
                            transform: flipStyle,
                        }, children: jsx("div", { className: "ProseMirror-static slide-renderer-prose", style: {
...
function LinePointMarker({ id, position, type, baseSize, color }) {
    ...
    return (jsx("marker", { id: `${id}-${type}-${position}`, markerUnits: "userSpaceOnUse", orient: "auto", markerWidth: size * 3, markerHeight: size * 3, refX: size * 1.5, refY: size * 1.5, children: jsx("path", { d: path, fill: color, transform: `scale(${size * 0.3}, ${size * 0.3}) rotate(${rotate}, 5, 5)` }) }));
}
...
function BaseLineElement({ elementInfo, animate }) {
    ...
    return (jsx("div", { className: "base-element-line", style: {
            position: 'absolute',
            top: `${elementInfo.top}px`,
            left: `${elementInfo.left}px`,
        }, children: jsx("div", { className: "element-content", style: {
                position: 'relative',
                width: '100%',
                height: '100%',
                filter: shadowStyle ? `drop-shadow(${shadowStyle})` : '',
            }, children: jsxs("svg", { overflow: "visible", width: svgWidth, height: svgHeight, style: { transformOrigin: '0 0', overflow: 'visible' }, children: [jsxs("defs", { children: [elementInfo.points[0] && (jsx(LinePointMarker, { id: elementInfo.id, position: "start", type: elementInfo.points[0], color: elementInfo.color, baseSize: elementInfo.width })), elementInfo.points[1] && (jsx(LinePointMarker, { id: elementInfo.id, position: "end", type: elementInfo.points[1], color: elementInfo.color, baseSize: elementInfo.width }))] }), jsx("path", { ref: pathRef, d: path, stroke: elementInfo.color, strokeWidth: elementInfo.width, strokeDasharray: lineDashArray, fill: "none", markerStart: drawComplete && elementInfo.points[0]
...
function Chart({ width: _width, height: _height, type, data, themeColors: rawThemeColors, textColor, lineColor, options, }) {
    ...
    return jsx("div", { ref: chartRef, className: "chart", style: { width: '100%', height: '100%' } });
}

function BaseChartElement({ elementInfo, target }) {
    return (jsx("div", { className: "base-element-chart", style: {
            position: 'absolute',
            top: `${elementInfo.top}px`,
            left: `${elementInfo.left}px`,
            width: `${elementInfo.width}px`,
            ...
            pointerEvents: target === 'thumbnail' ? 'none' : undefined,
                ...
                height: '100%',
                transform: `rotate(${elementInfo.rotate}deg)`,
            }, children: jsxs("div", { className: "element-content", style: { width: '100%', height: '100%', backgroundColor: elementInfo.fill }, children: [jsx(ElementOutline, { width: elementInfo.width, height: elementInfo.height, outline: elementInfo.outline }), jsx(Chart, { width: elementInfo.width, height: elementInfo.height, type: elementInfo.chartType, data: elementInfo.data, themeColors: elementInfo.themeColors, textColor: elementInfo.textColor, lineColor: elementInfo.lineColor, options: elementInfo.options })] }) }) }));
}

function BaseLatexElement({ elementInfo }) {
    return (jsx("div", { className: "base-element-latex", style: {
            position: 'absolute',
            top: `${elementInfo.top}px`,
            left: `${elementInfo.left}px`,
            width: `${elementInfo.width}px`,
            height: `${elementInfo.height}px`,
                ...
                }, children: elementInfo.html ? (jsx(KatexContent, { html: elementInfo.html, width: elementInfo.width, height: elementInfo.height, align: elementInfo.align })) : elementInfo.path && elementInfo.viewBox ? (jsx("svg", { overflow: "visible", width: elementInfo.width, height: elementInfo.height, stroke: elementInfo.color, strokeWidth: elementInfo.strokeWidth, fill: "none", strokeLinecap: "round", strokeLinejoin: "round", style: { transformOrigin: '0 0', overflow: 'visible' }, children: jsx("g", { transform: `scale(${elementInfo.width / elementInfo.viewBox[0]}, ${elementInfo.height / elementInfo.viewBox[1]}) translate(0,0) matrix(1,0,0,1,0,0)`, children: jsx("path", { d: elementInfo.path }) }) })) : null }) }) }));
}
const ALIGN_MAP = {
    left: 'flex-start',
    center: 'center',
...
function KatexContent({ html, width, height, align = 'center', }) {
    ...
    return (jsx("div", { style: {
        ...
        }, children: jsx("div", { ref: innerRef, className: "slide-renderer-prose", style: {
...
function StaticTable({ elementInfo }) {
    ...
    return (jsxs("table", { className: "slide-renderer-prose", style: {
            width: '100%',
            borderCollapse: 'collapse',
            tableLayout: 'fixed',
        }, children: [jsx("colgroup", { children: colWidths.map((w, i) => (jsx("col", { style: { width: `${w * width}px` } }, i))) }), jsx("tbody", { children: data.map((row, rowIdx) => (jsx("tr", { style: { height: `${rowHeights?.[rowIdx] ?? cellMinHeight}px` }, children: row.map((cell, colIdx) => {
                        ...
                        const borderCss = cellBorders &&
                            ...
                            : { border: borderStyle };
                        return (jsx("td", { colSpan: cell.colspan > 1 ? cell.colspan : undefined, rowSpan: cell.rowspan > 1 ? cell.rowspan : undefined, style: {
                                ...borderCss,
                                backgroundColor: bgColor,
                                ...textStyle,
                            }, children: jsx("div", { className: "slide-renderer-cell-text", style: {
...
function BaseTableElement({ elementInfo, target }) {
    return (jsx("div", { className: "base-element-table", style: {
            position: 'absolute',
            top: `${elementInfo.top}px`,
            left: `${elementInfo.left}px`,
            width: `${elementInfo.width}px`,
            ...
            pointerEvents: target === 'thumbnail' ? 'none' : undefined,
                ...
                height: '100%',
                transform: `rotate(${elementInfo.rotate}deg)`,
            }, children: jsx("div", { className: "element-content", style: { width: '100%', height: '100%' }, children: jsx(StaticTable, { elementInfo: elementInfo }) }) }) }));
}

function BaseVideoElement({ elementInfo, renderVideo }) {
    return (jsx("div", { className: "element-content", "data-video-element": true, style: {
            position: 'absolute',
            top: `${elementInfo.top}px`,
            left: `${elementInfo.left}px`,
            width: `${elementInfo.width}px`,
            height: `${elementInfo.height}px`,
        }, onClick: (e) => e.stopPropagation(), onPointerDown: (e) => e.stopPropagation(), children: jsx("div", { style: {
                width: '100%',
                height: '100%',
                transform: `rotate(${elementInfo.rotate}deg)`,
            ...
            jsx("video", { style: { width: '100%', height: '100%', objectFit: 'contain' }, ...(elementInfo.src ? { src: elementInfo.src } : {}), poster: elementInfo.poster, preload: "metadata", controls: !!elementInfo.src })) : (jsx("div", { style: {
                    width: '100%',
                    height: '100%',
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    borderRadius: '4px',
                }, children: jsx("svg", { style: { width: '48px', height: '48px', color: '#9ca3af' }, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round", children: jsx("polygon", { points: "5 3 19 12 5 21 5 3" }) }) })) }) }));
}
...
function TypingReveal({ html, durationMs, revealSteps, onComplete, }) {
    ...
    return (jsxs("span", { style: { position: 'relative', display: 'inline-block' }, children: [jsx("span", { style: {
                    clipPath: `inset(0 ${(1 - revealPct) * 100}% 0 0)`,
                }, dangerouslySetInnerHTML: { __html: html } }), revealPct < 1 && (jsx("span", { style: {
                    position: 'absolute',
                    top: 0,
                    width: '2px',
...
function CodeLineRow({ line, lineNumber, highlightedHtml, showLineNumbers, animState, animate, typingDelay, }) {
    ...
    const [replacePhase, setReplacePhase] = useState('idle');
    const [oldHtml, setOldHtml] = useState(null);
    useEffect(() => {
    ...
    if (replacePhase === 'select' && oldHtml) {
        contentNode = jsx("span", { dangerouslySetInnerHTML: { __html: oldHtml } });
    }
    else if (typing) {
        contentNode = (jsx(TypingReveal, { html: highlightedHtml, durationMs: typingDuration, revealSteps: revealSteps, onComplete: handleTypingComplete }));
    }
    else {
        contentNode = jsx("span", { dangerouslySetInnerHTML: { __html: highlightedHtml } });
    }
    return (jsxs(motion.div, { initial: isNewLine ? { opacity: 0, height: 0 } : false, animate: {
            opacity: 1,
            height: 'auto',
            backgroundColor: bgColor,
            transition: {
            ...
            fontSize: 'inherit',
            overflow: 'hidden',
        }, children: [showLineNumbers && (jsx("span", { style: {
                    flexShrink: 0,
                    textAlign: 'right',
                    paddingRight: '16px',
                    paddingLeft: '8px',
                    ...
                    color: '#9ca3af',
                    userSelect: 'none',
                }, children: lineNumber })), jsx("span", { style: { flex: 1, paddingRight: '16px', whiteSpace: 'pre', tabSize: 4 }, children: contentNode })] }));
}
// ==================== BaseCodeElement ====================
function BaseCodeElement({ elementInfo, animate }) {
    ...
    return (jsx("div", { ref: wrapperRef, className: "base-element-code", style: {
            position: 'absolute',
            top: `${elementInfo.top}px`,
            left: `${elementInfo.left}px`,
            width: `${elementInfo.width}px`,
            height: `${elementInfo.height}px`,
        }, onPointerDown: stopPointer, onClick: stopPointer, children: jsx("div", { className: "rotate-wrapper", style: {
                width: '100%',
                height: '100%',
                transform: `rotate(${elementInfo.rotate}deg)`,
            }, children: jsxs("div", { className: "element-content", style: {
                    ...
                    fontSize: `${fontSize}px`,
                            ...
                            borderBottom: '1px solid #e5e7eb',
                        }, children: [jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [jsxs("div", { style: { display: 'flex', gap: '6px' }, children: [jsx("div", { style: {
                                                    width: '10px',
                                                    height: '10px',
                                                    borderRadius: '9999px',
                                                    background: '#ff5f57',
                                        ...
                                        }, children: fileName }))] }), jsx("span", { style: {
                                    color: '#9ca3af',
                                    fontSize: '10px',
                                    textTransform: 'uppercase',
                                    letterSpacing: '0.05em',
                                    fontWeight: 500,
                                }, children: langDisplay })] }), jsx("div", { ref: codeBodyRef, style: {
                            flex: 1,
                            overflow: 'auto',
                            paddingTop: '8px',
                            paddingBottom: '8px',
                            ...
                            touchAction: 'none',
                        }, children: jsx("div", { style: { minWidth: 'max-content' }, children: jsx(AnimatePresence, { initial: false, mode: "popLayout", children: lineHtmlMap.map((lineData, index) => {
                                    const line = lines[index];
                                    if (!line)
                                        return null;
                                    return (jsx(CodeLineRow, { line: line, lineNumber: index + 1, highlightedHtml: lineData.html, showLineNumbers: showLineNumbers, animState: animStates.get(line.id), animate: !!animate, typingDelay: typingDelays.get(line.id) ?? 0 }, line.id));
                                }) }) }) })] }) }) }));
}
// ==================== Utilities ====================
...
export { BaseChartElement as B, ElementOutline as E, BaseCodeElement as a, BaseImageElement as b, BaseLatexElement as c, BaseLineElement as d, BaseShapeElement as e, BaseTableElement as f, BaseTextElement as g, BaseVideoElement as h, useElementFlip as i, useElementOutline as j, useElementShadow as k, useElementFill as u };
//# sourceMappingURL=BaseCodeElement-Bh-Bfdz6.js.map
